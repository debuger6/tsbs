...
func (t *elasticTarget) TargetSpecificFlags(flagPrefix string, flagSet *pflag.FlagSet) {
...
func (t *elasticTarget) TargetName() string {
	return constants.FormatElasticsearch
}

func (t *elasticTarget) Serializer() serialize.PointSerializer {
	return &Serializer{}
}

func (t *elasticTarget) Benchmark(string, *source.DataSourceConfig, *viper.Viper) (targets.Benchmark, error) {
